...
int button = 9;
 //pin of button
int pedRed = 8;
 //configure light for pedestrians
int pedGreen = 7;
int crossTime = 5000;
 //time for pedestrians to pass unsigned
long changeTime;
...
//red traffic light off
//yellow traffic light on
//yellow traffic light off
//green traffic light on
changeTime = millis()
 // record the duration since last
change
